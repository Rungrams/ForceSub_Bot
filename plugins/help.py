...
@Client.on_message(filters.incoming & filters.command(['source_code', 'source_code@ForceSubscribe_tobot']))
def _source_code(client, message):
	...
	reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("📜Souce Code📜", url="https://t.me/bot_repo")
                ],
                [
                    InlineKeyboardButton("CHANNEL📢", url="https://t.me/TOBOT_UPDATE"),
                    InlineKeyboardButton("GROUP👥", url="https://t.me/tobotupdate")
...
@Client.on_message(filters.incoming & filters.command(['help', 'help@ForceSubscribe_tobot']))
def _help(client, message):
    ...
    if update_channel:
        try:
            ...
            client.send_message(
                chat_id=message.chat.id,
                text="Hey use this command in my pm. \nFor more help ask in my [Support Group](https://t.me/tobotupdate).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
